...
const Ratings = ({ visible, posts, userId, reviews }) => {
	...
	return (
				...
				<div className="modal-box relative">
					...
					<div className="card-body items-center text-center">
						<h3 className="ml-2 text-sm font-semibold text-gray-900 dark:text-black">
							{reviews[userId - 1].title}
						</h3>
						<p className="mb-2 font-light text-gray-500 dark:text-gray-400">
							{reviews[userId - 1].desc}
						</p>
		...
		//         <div className="card-body items-center text-center">
		//             <h3 className="ml-2 text-sm font-semibold text-gray-900 dark:text-black">Thinking to buy another one!</h3>
